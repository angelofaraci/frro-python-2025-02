...
while cap.isOpened():
    ...
    cv2.line(
        frame,
        (linea_división, 0),
        (linea_división + 30, frame.shape[1]),
        (255, 0, 0),
        offset,
    )
    ...
    for cnt in contours:
        ...
        if area > 500:  # filtra objetos pequeños
            ...
            if (linea_inferior - offset) < cy < (
                linea_inferior + offset
            ) and cx > linea_división:
            ...
            if (linea_superior - offset) < cy < (
                linea_superior + offset
            ) and cx < linea_división:
    ...
    cv2.putText(
        frame,
        f"entradas abajo: {contador_entrante_abajo}",
        (10, 150),
        cv2.FONT_HERSHEY_SIMPLEX,
        1,
        (0, 255, 0),
    ...
    cv2.putText(
        frame,
        f"salientes abajo: {contador_saliente_abajo}",
        (10, 200),
        cv2.FONT_HERSHEY_SIMPLEX,
        1,
        (0, 0, 255),
    ...
    cv2.putText(
        frame,
        f"entradas arriba: {contador_entrante_arriba}",
        (10, 250),
        cv2.FONT_HERSHEY_SIMPLEX,
        1,
        (0, 255, 0),
    ...
    cv2.putText(
        frame,
        f"salidas arriba: {contador_saliente_arriba}",
        (10, 300),
        cv2.FONT_HERSHEY_SIMPLEX,
        1,
        (0, 0, 255),
